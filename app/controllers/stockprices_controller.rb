...
require 'graph'
  ...
  def hover_daily
    ...
    respond_to do |f|
      f.html {
        render :partial => 'shared/graph/daily_price', :locals => { :price => price_data } #this is working...
      }
    end
   ...
   def hover_intraday
    ...
    respond_to do |f|
      f.html {
        render :partial => 'shared/graph/intraday_price', :locals => { :price => price_data } #this is working...
      }
    end
  end
